    ...
    <div class="border mt-2 rounded">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent1">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item pe-3">
                        <div class="dropdown">
                            <a class="btn btn-default dropdown-toggle" href="#" role="button" id="loaisanpham"
                               data-bs-toggle="dropdown" aria-expanded="false">Loại sản phẩm</a>

                            <ul class="dropdown-menu" aria-labelledby="loaisanpham">
                                @foreach($list_category as $category)
                                    <li><a class="dropdown-item"
                                           href="{{route('category', $category->id)}}">{{$category->title}}</a></li>
                                @endforeach
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item pe-3">
                        <div class="dropdown">
                            <a class="btn btn-default dropdown-toggle" href="#" role="button" id="giasanpham"
                               data-bs-toggle="dropdown" aria-expanded="false">Giá</a>
                            <ul class="dropdown-menu" aria-labelledby="giasanpham">
                                <li><a class="dropdown-item" href="{{route('price', 'duoi-2-trieu')}}">Dưới 2 triệu</a>
                                </li>
                                <li><a class="dropdown-item" href="{{route('price', 'tu-2-den-4-trieu')}}">Từ 2 đến 4
                                        triệu</a></li>
                                <li><a class="dropdown-item" href="{{route('price', 'tu-4-den-7-trieu' )}}">Từ 4 đến 7
                                        triệu</a></li>
                                <li><a class="dropdown-item" href="{{route('price', 'tu-7-den-13-trieu')}}">Từ 7 đến 13
                                        triệu</a></li>
                                <li><a class="dropdown-item" href="{{route('price', 'tu-13-den-20-trieu')}}">Từ 13 đến
                                        20 triệu</a></li>
                                <li><a class="dropdown-item" href="{{route('price', 'tren-20-trieu')}}">Trên 20
                                        triệu</a></li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item pe-3">
                        <div class="dropdown">
                            <a class="btn btn-default dropdown-toggle" href="#" role="button" id="ram"
                               data-bs-toggle="dropdown" aria-expanded="false">Ram</a>
                    ...
                    <li class="nav-item pe-3">
                        <div class="dropdown">
                            <a class="btn btn-default dropdown-toggle" href="#" role="button" id="dungluong"
                               data-bs-toggle="dropdown" aria-expanded="false">Dung Lượng Lưu Trữ</a>
                    ...
                    <li class="nav-item pe-3">
                        <div class="dropdown">
                            <a class="btn btn-default dropdown-toggle" href="#" role="button" id="pinsac"
                               data-bs-toggle="dropdown" aria-expanded="false">Pin & Sạc</a>

                            <ul class="dropdown-menu" aria-labelledby="pinsac">
                                <li><a class="dropdown-item" href="{{route('pin-sac', 'pin-khung-tren-5000-mah')}}">Pin
                                        khủng trên 5000mAh</a></li>
                                <li><a class="dropdown-item" href="{{route('pin-sac', 'sac-nhanh-tren-20w')}}">Sạc nhanh
                                        trên 20w</a></li>
                                <li><a class="dropdown-item" href="{{route('pin-sac', 'sac-khong-day')}}">Sạc không
                                        dây</a></li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item pe-3">
                        <div class="dropdown">
                            <a class="btn btn-default dropdown-toggle" href="#" role="button" id="tinhnang"
                               data-bs-toggle="dropdown" aria-expanded="false">Tính Năng Đặc Biệt</a>

                            <ul class="dropdown-menu" aria-labelledby="tinhnang">
                                <li><a class="dropdown-item" href="{{route('tinh-nang', 'khang-nuoc-bui')}}">Kháng nước,
                                        bụi</a></li>
                                <li><a class="dropdown-item" href="{{route('tinh-nang', 'ho-tro-5g')}}">Hỗ trợ 5G</a>
                                </li>
                                <li><a class="dropdown-item" href="{{route('tinh-nang', 'bao-mat-khuon-mat-3d')}}">Bảo
                                        mật khuôn mặt 3D</a></li>
                                <li><a class="dropdown-item" href="{{route('tinh-nang', 'chong-rung-quang-hoc')}}">Chống
                                        rung quang học</a></li>
                            </ul>
                        </div>
                    </li>
        ...
        <div class="mt-3 m-2 btn-group">
            <label class="">Chọn điện thoại theo nhu cầu: <br>
                @foreach($list_category as $category)
                    <a type="button" href="{{route('category', $category->id)}}"
                       class="btn btn-default border me-2">{{$category->title}}</a>
                @endforeach
            </label>
        </div>
    </div>
            ...
            <div class="col-sm-3">
                <div class="card p-3 mb-5 bg-body rounded" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['url' => '/save-cart', 'method'=>'POST', 'enctype'=>'multipart/form-data']) !!}
                        {{--soluong--}}
                        <input name="qty" type="hidden" min="1" max="{{$product_sale->number}}"
                               class="cart_product_qty_{{$product_sale->id}}" value="1"/>
                        {!! Form::hidden('productid_hidden', $product_sale->id) !!}
                        <a href="{{route('detail',$product_sale->id)}}"
