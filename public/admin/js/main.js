...
(function ($) {
    ...
    $container.append('<h5>Customize</h5><hr class="mb-2"/>')
    ...
    var $header_fixed_checkbox = $('<input />', {
        ...
        $(this).is(':checked') ? $('body').addClass('layout-navbar-fixed') : $('body').removeClass('layout-navbar-fixed')
    })
    ...
    var $dropdown_legacy_offset_checkbox = $('<input />', {
        ...
        $(this).is(':checked') ? $('.main-header').addClass('dropdown-legacy') : $('.main-header').removeClass('dropdown-legacy')
    })
    ...
    var $no_border_checkbox = $('<input />', {
        ...
        $(this).is(':checked') ? $('.main-header').addClass('border-bottom-0') : $('.main-header').removeClass('border-bottom-0')
    })
    ...
    var $sidebar_mini_md_checkbox = $('<input />', {
        ...
        $(this).is(':checked') ? $('body').addClass('sidebar-mini-md') : $('body').removeClass('sidebar-mini-md')
    })
    ...
    var $sidebar_mini_xs_checkbox = $('<input />', {
        ...
        $(this).is(':checked') ? $('body').addClass('sidebar-mini-xs') : $('body').removeClass('sidebar-mini-xs')
    })
    ...
    var $flat_sidebar_checkbox = $('<input />', {
        ...
        $(this).is(':checked') ? $('.nav-sidebar').addClass('nav-flat') : $('.nav-sidebar').removeClass('nav-flat')
    })
    ...
    var $legacy_sidebar_checkbox = $('<input />', {
        ...
        $(this).is(':checked') ? $('.nav-sidebar').addClass('nav-legacy') : $('.nav-sidebar').removeClass('nav-legacy')
    })
    ...
    var $compact_sidebar_checkbox = $('<input />', {
        ...
        $(this).is(':checked') ? $('.nav-sidebar').addClass('nav-compact') : $('.nav-sidebar').removeClass('nav-compact')
    })
    ...
    var $child_indent_sidebar_checkbox = $('<input />', {
        ...
        $(this).is(':checked') ? $('.nav-sidebar').addClass('nav-child-indent') : $('.nav-sidebar').removeClass('nav-child-indent')
    })
    ...
    var $child_hide_sidebar_checkbox = $('<input />', {
        ...
        $(this).is(':checked') ? $('.nav-sidebar').addClass('nav-collapse-hide-child') : $('.nav-sidebar').removeClass('nav-collapse-hide-child')
    })
    ...
    var $no_expand_sidebar_checkbox = $('<input />', {
        ...
        $(this).is(':checked') ? $('.main-sidebar').addClass('sidebar-no-expand') : $('.main-sidebar').removeClass('sidebar-no-expand')
    })
    ...
    var $footer_fixed_checkbox = $('<input />', {
        ...
        $(this).is(':checked') ? $('body').addClass('layout-footer-fixed') : $('body').removeClass('layout-footer-fixed')
    })
